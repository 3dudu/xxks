 ...
 * @file _jyfwCategoryWidget.php
 * @brief 商品分类视图插件
 * @author nswe
 * @version 4.4
 * @date 2016/3/26 9:47:48
 */
class _jyfwCategoryWidget extends pluginBase
{
	//是否加载过了JS
	...
	public function reg()
	{
		plugin::reg("jyfwCategoryWidget",$this,"showWidget");
		plugin::reg("onBeforeCreateAction@block@jyfw_category",function(){
			self::controller()->jyfw_category = function(){$this->view("jyfwCategory");};
		});
	}
	...
	public function showWidget($param)
	{
		...
		$param['table'] = isset($param['table'])     ? $param['table']     : "jyfw_category";
		...
		if(self::$isJsLoad == false)
		{
			...
			$widgetRoot   = IUrl::creatUrl("")."plugins/_jyfwCategoryWidget/jyfwCategoryWidget.js";
...
jQuery(function()
{
	_jyfwCategoryWidget = new jyfw_categoryWidget({$param});
});
</script>
OEF;
	}
