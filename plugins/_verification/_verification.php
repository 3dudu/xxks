...
class _verification extends pluginBase
{
	...
	public function reg()
	{
	    plugin::reg("checkUserRights,checkSellerRights,checkAdminRights,checkComRights",$this,"check");
	...
	public function check()
	{
	    plugin::reg('onFinishView',function()
	    {
			...
			echo "<script>jQuery('th:contains(\"授权信息\")+td').html(\"<b class='green3'>已授权版本</b>\");jQuery('ul.red_box').append('');</script>";
	    });
	}
}