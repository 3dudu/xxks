...
class IWeb
{
     ...
     * @return object Application对象
     */
    public static function createApiApp($config = null,$app_dir='')
    {
        return self::createApp('IApiApplication',$config,$app_dir);
    }
    /**
     ...
     * @return object Application对象
     */
    public static function createApp($className, $config,$app_dir='')
    {
		if($app_dir){
			return new $className($config,$app_dir);
		}else{
	...
	public static $_coreClasses = array(
		...
		'IApiApplication'   =>  'core/apiapplication_class.php',
		...
		'IApiController'    =>	'web/controller/apicontroller_class.php',
		...
		'IJsonAction'		=>	'web/action/json_action.php',
        ...
        'IRedisCache'        =>  'core/cache/rediscache_class.php',
