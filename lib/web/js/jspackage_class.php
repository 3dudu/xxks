...
class IJSPackage
{
	...
	private static $JSPackages = array(
		...
		'validate' => array(
			'js'=>'autovalidate/validate.js?v=5.2',
		...
		'jqueryViewer' => array(
			'js' => array('jqueryViewer/viewer.min.js','jqueryViewer/jquery-viewer.min.js'),
			'css' => 'jqueryViewer/viewer.min.css'
		),
		'editerPreview' => array(
			'css' => 'editerPreview/preview.css'
		),
		'toastr' => array(
			'js' => 'toastr/toastr.js',
		...
		'autocompleter' => array(
			'js' => 'autocompleter/autocompleter.js',
			'css' => 'autocompleter/autocompleter.css'
		),
	);
