...
class smsTemplate
{
	...
	{
		$siteConfigObj = self::getPlatForm();
		$platform = $siteConfigObj->sms_platform;
		if('yuntong' == $platform){
			$dataArray = array();
			foreach ($data as $k => $v)
			{
			...
			return array('datas'=>$dataArray,'tempId'=>$siteConfigObj->sms_sendGoods);
		}
	...
	public static function findPassword($data = null)
	{
		...
		if('yuntong' == $platform){
			...
			return array('datas'=>$dataArray,'tempId'=>$siteConfigObj->sms_findPassword);
		}
	...
	public static function checkCode($data = null)
	{
		...
		if('yuntong' == $platform){
			...
			return array('datas'=>$dataArray,'tempId'=>$siteConfigObj->sms_checkCode);
		}
		$templateString = "您的验证码为:{mobile_code},请注意保管!";
		return strtr($templateString,$data);
	}
	...
	public static function takeself($data = null)
	{
		...
		if('yuntong' == $platform){
			...
			return array('datas'=>$dataArray,'tempId'=>$siteConfigObj->sms_takeself);
		}
	...
	public static function sellerReg($data = null)
	{
		...
		if('yuntong' == $platform){
			...
			return array('datas'=>$dataArray,'tempId'=>$siteConfigObj->sms_sellerReg);
		}
	...
	public static function sellerCheck($data = null)
	{
		...
		if('yuntong' == $platform){
			...
			return array('datas'=>$dataArray,'tempId'=>$siteConfigObj->sms_sellerCheck);
		}
	...
	public static function payFinishToAdmin($data = null)
	{
		...
		if('yuntong' == $platform){
			...
			return array('datas'=>$dataArray,'tempId'=>$siteConfigObj->sms_payFinishToAdmin);
		}
	...
	public static function payFinishToUser($data = null)
	{
		...
		if('yuntong' == $platform){
			...
			return array('datas'=>$dataArray,'tempId'=>$siteConfigObj->sms_payFinishToUser);
		}
	...
	public static function notify($data = null)
	{
		...
		if('yuntong' == $platform){
			...
			return array('datas'=>$dataArray,'tempId'=>$siteConfigObj->sms_notify);
		}
	...
	public static function takeselfGoods($data = null)
	{
		...
		if('yuntong' == $platform){
			...
			return array('datas'=>$dataArray,'tempId'=>$siteConfigObj->sms_takeselfGoods);
		}
		$templateString = "您好{user_name},订单号:{order_no},在{takeself}已经成功提货";
		return strtr($templateString,$data);
	}

	public static function mobileBind($data = null)
	{
		$siteConfigObj = self::getPlatForm();

		return array(
			'TemplateCode'=>$siteConfigObj->sms_ali_code_reg,
			'TemplateParam'=>JSON::encode($data)
		);
	}

	public static function mobileFind($data = null)
	{
		$siteConfigObj = self::getPlatForm();

		return array(
			'TemplateCode'=>$siteConfigObj->sms_ali_code_find,
			'TemplateParam'=>JSON::encode($data)
		);
	}
