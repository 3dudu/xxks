...
{
	//默认开启的插件列表
	private static $defaultList = array("_verification","_companyCategoryWidget","_memberCategoryWidget","_jyfwCategoryWidget","_authorization","_userInfo","_initData","_hsms","_event");
