...
class checkConfig
{
	...
	private $recom_extension = array('zip','curl','OpenSSL','mbstring','sockets','redis');
	private $writeable_dir   = array('config/config.php','config/site_config.php','install','backup','index.php','upload','runtime');
	private $readable_dir    = array('config/config_default.php','install/base.sql','install/app.sql','install/area_data.sql');
