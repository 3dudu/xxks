					...
					<div class="gray_box">
						<div class="box">
							<table class="form_table">
								...
								<tr>
									<th>数据库表前缀</th>
									<td><input class="gray" type="text" value='xx_' name='db_pre' /><br /><label class="error" id='db_pre_label' style='display:none'><img src="images/failed.gif" width="16" height="15" />请填写正确的表前缀字符</label></td>
								</tr>
								<tr>
							...
							<strong>安装选择</strong>
							<label><input class="checkbox" type="checkbox" name='install_type[]' checked="checked" readonly="readonly" value='base' />基础数据</label><br />
							<label><input class="checkbox" type="checkbox" name='install_type[]' value='app' />应用数据数据</label>
							<label><input class="checkbox" type="checkbox" name='install_type[]' value='area' />地区数据</label>
							<label><input class="checkbox" type="checkbox" name='install_type[]' value='shop' />商城数据</label>
